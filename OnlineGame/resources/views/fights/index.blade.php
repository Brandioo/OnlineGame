        ...
        <div class="container">
            ...
            <div class="media-content">
                <div class="row">
                    <div class="col-lg-6">
                        <div>
                            <a href="{{route('fights.create')}}" class="btn-primary btn" style="margin: 20px 0"
                               type="submit">Create Fight</a>
                            <div class="media-sidebar">
                                <ul id="fight__list" class="quick-links">
                                </ul>
                            </div>
                        </div>
                        {{--                        <div class="col-lg-9">--}}
                                ...
                                `<li>
                                    <a class="info hero__info" href="javascript:;" data-kind='${JSON.stringify(element)}'
                                        ...
                                        <div class="quick-links-text">
                                            <h5>Winner</h5>
                                            <span class="quick-links__title">${element.winner_id}</span>
